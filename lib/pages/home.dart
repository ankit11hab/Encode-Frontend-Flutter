...
class _HomeState extends State<Home> {
  ...
  Future<int> getData() async {
    var res1 = await http.post("https://27e8-146-196-45-54.ngrok.io/auth/get_profile/",
    ...
    var res2 = await http.post("https://27e8-146-196-45-54.ngrok.io/geo/decode_latlang/",
        headers: <String, String>{
          'Content-Type': 'application/json; charset=UTF-8',
          'Authorization': 'Bearer $access',
        },
    ...
    var res3 = await http.post("https://27e8-146-196-45-54.ngrok.io/passenger/history/",
        headers: <String, String>{
          'Content-Type': 'application/json; charset=UTF-8',
          'Authorization': 'Bearer $access',
        });
    ...
    var res4 = await http.post("https://27e8-146-196-45-54.ngrok.io/passenger/active/",
        headers: <String, String>{
          'Content-Type': 'application/json; charset=UTF-8',
          'Authorization': 'Bearer $access',
        });
