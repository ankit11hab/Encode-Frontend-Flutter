...
class _HomeState extends State<Home> {
  ...
  Future<int> getData() async {
    var res1 = await http.post(urlF+"auth/get_profile/",
    ...
    var res2 = await http.post(urlF+"geo/decode_latlang/",
        headers: <String, String>{
          'Content-Type': 'application/json; charset=UTF-8',
          'Authorization': 'Bearer $access',
        },
    ...
    var res3 = await http.post(urlF+"passenger/history/",
        headers: <String, String>{
          'Content-Type': 'application/json; charset=UTF-8',
          'Authorization': 'Bearer $access',
        });
    ...
    var res4 = await http.post(urlF+"passenger/active/",
        headers: <String, String>{
          'Content-Type': 'application/json; charset=UTF-8',
          'Authorization': 'Bearer $access',
        });
